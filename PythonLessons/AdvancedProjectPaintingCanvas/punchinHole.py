# This program punch a hole on the picture as the mouse move
# It allow us to see the picture base on the mouse movement
# The rest of the picture is cover with dark and allow us to see only
# the cursor hover on the picture
