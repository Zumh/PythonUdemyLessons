# This program will create couple of recangles and much more....
...
master = Tk()
# Let's create couple of rectangles
...
w.create_line(0,0, box[0][0], box[0][1], fill=colours[0], width=5)
...
w.create_line(box[0][2],box[0][3], canvas_width, canvas_height, fill=colours[0], width=5)
