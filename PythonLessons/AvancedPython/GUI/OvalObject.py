# Creating Oval object or shapes
...
w = Canvas(master, width = canvas_width, height=canvas_heigth)
...
step_y = int(canvas_heigth/ nsteps)

for i in range(1, nsteps):
    polygon_star(w, i*step_x, i*step_y,p,t, outline='red', fill='green', width=3)
    polygon_star(w, i*step_x, canvas_heigth - i*step_y, p, t, outline='red', fill='green', width=3)

mainloop()


# oval objects widgets (creating a checkered canvas)
